 ...
 * The Bithereum Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Bithereum Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/Bithereum_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Bithereum address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/Bithereum_tooltip"), tr("&About Bithereum"), this);
    aboutAction->setToolTip(tr("Show information about Bithereum"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Bithereum"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/Bithereum_tooltip"), tr("Show/Hide &Bithereum"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Bithereum window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/Bithereum_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Bithereum_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/Bithereum_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Bithereum client"));
    trayIcon->setIcon(QIcon(":/icons/Bithereum_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bithereum network", "", count));
}
