...
namespace Checkpoints
{
    ...
    // Bithereum: synchronized checkpoint (centrally broadcasted)
    ...
    // Bithereum: get last synchronized checkpoint
    ...
    // Bithereum: only descendant of current sync-checkpoint is allowed
    ...
    // Bithereum: reset synchronized checkpoint to last hardened checkpoint
...
// Bithereum: sync-checkpoint master key
...
// Bithereum: verify signature of sync-checkpoint message
...
// Bithereum: process synchronized checkpoint
