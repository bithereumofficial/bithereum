...
// Copyright (c) 2014 The Bithereum developers
...
// for both Bithereumd and Bithereum(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Bithereum releases, the client name should be selected from
